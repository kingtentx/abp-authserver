    ...
    public partial class _0719 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sys_authority_detail", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");

            migrationBuilder.CreateTable(
                name: "sys_authority_group",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sys_authority_group", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");

            migrationBuilder.CreateTable(
                name: "sys_gateway_config",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "名称")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sys_gateway_config", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HigherMenuOptions = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ParentId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    Title = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Route = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true, comment: "路由名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Component = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true, comment: "组件名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Sort = table.Column<int>(type: "int", nullable: false),
                    Redirect = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true, comment: "路由重定向")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Icon = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "图标")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExtraIcon = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "扩展图标")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EnterTransition = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "页面进场加载动画")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LeaveTransition = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "页面离场加载动画")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ActivePath = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "菜单激活")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Auths = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "权限")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FrameSrc = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true, comment: "iframe 链接地址")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FrameLoading = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true, comment: "iframe加载动画")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    KeepAlive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    HiddenTag = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    FixedTag = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ShowLink = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ShowParent = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    ClientType = table.Column<int>(type: "int", nullable: false, comment: "客户端类型 0-PC,1-APP,2-H5"),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sys_role_authority", x => new { x.RoleId, x.AuthorityId });
                })
                .Annotation("MySql:CharSet", "utf8mb4");
